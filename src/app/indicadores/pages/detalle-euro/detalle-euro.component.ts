...
@Component({
  selector: 'app-detalle-euro',
  templateUrl: './detalle-euro.component.html',
  styleUrls: ['./detalle-euro.component.css']
})
export class DetalleEuroComponent {
