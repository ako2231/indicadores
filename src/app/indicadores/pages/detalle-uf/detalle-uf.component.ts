...
@Component({
  selector: 'app-detalle-uf',
  templateUrl: './detalle-uf.component.html',
  styleUrls: ['./detalle-uf.component.css']
})
export class DetalleUfComponent {
